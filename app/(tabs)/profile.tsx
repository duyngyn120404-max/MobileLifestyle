  ...
  return (
    <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {/* Edit/Save Button */}
        <TouchableOpacity style={styles.editButton} onPress={toggleEdit} disabled={isSaving}>
          <MaterialCommunityIcons name={isEditing ? "check" : "pencil"} size={20} color="#fff" />
          <Text style={styles.editButtonText}>
            {isSaving ? "Đang lưu..." : isEditing ? "Save Changes" : "Edit Profile"}
          </Text>
        </TouchableOpacity>
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.settingItem} onPress={() => setShowPrivacySecurity(true)}>
            <View style={styles.settingLeft}>
              <MaterialCommunityIcons name="lock" size={24} color="#007AFF" />
      ...
      <Modal visible={showPrivacySecurity} animationType="slide" transparent onRequestClose={() => setShowPrivacySecurity(false)}>
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
          ...
          <View style={styles.modalContent}>
            ...
            <ScrollView style={styles.modalBody}>
              ...
              <View style={styles.infoBox}>
                ...
                <Text style={[styles.infoLabel, { marginTop: 12 }]}>Build</Text>
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: "#fff", paddingVertical: 24, paddingTop: 50, alignItems: "center", borderBottomWidth: 1, borderBottomColor: "#eee" },
  ...
  editButton: {
    ...
    marginHorizontal: 16, marginVertical: 16, backgroundColor: "#007AFF",
    paddingVertical: 12, borderRadius: 12, gap: 8,
  },
  editButtonText: { color: "#fff", fontSize: 16, fontWeight: "600" },
  section: { backgroundColor: "#fff", marginHorizontal: 16, marginVertical: 8, borderRadius: 12, padding: 16 },
  ...
  input: {
    ...
    paddingVertical: 10, fontSize: 14, color: "#333", borderWidth: 1, borderColor: "#e0e0e0",
  },
  inputDisabled: { backgroundColor: "#fafafa", color: "#666" },
  settingItem: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: "#f5f5f5" },
  settingLeft: { flexDirection: "row", alignItems: "center", gap: 12 },
  settingText: { fontSize: 15, color: "#333", fontWeight: "500" },
  logoutButton: {
    flexDirection: "row", alignItems: "center", justifyContent: "center",
    marginHorizontal: 16, marginVertical: 16, backgroundColor: "#fff",
    paddingVertical: 12, borderRadius: 12, gap: 8, borderWidth: 1, borderColor: "#FF3B30",
  },
  logoutButtonText: { color: "#FF3B30", fontSize: 16, fontWeight: "600" },
  footer: { height: 20 },
  modalOverlay: { flex: 1, backgroundColor: "#f5f5f5" },
  modalContent: { flex: 1, backgroundColor: "#fff" },
  modalHeader: {
    flexDirection: "row", justifyContent: "space-between", alignItems: "center",
    paddingHorizontal: 16, paddingVertical: 12, paddingTop: 70,
    borderBottomWidth: 1, borderBottomColor: "#f5f5f5",
  },
  modalTitle: { fontSize: 18, fontWeight: "bold", color: "#333" },
  modalBody: { padding: 16 },
  settingRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingVertical: 16, borderBottomWidth: 1, borderBottomColor: "#f5f5f5" },
  settingLabel: { fontSize: 15, fontWeight: "600", color: "#333" },
  settingDescription: { fontSize: 13, color: "#999", marginTop: 4 },
  actionButton: { flexDirection: "row", alignItems: "center", paddingVertical: 14, paddingHorizontal: 12, backgroundColor: "#f5f5f5", borderRadius: 10, marginBottom: 12, gap: 12 },
  actionButtonText: { fontSize: 15, fontWeight: "500", color: "#007AFF" },
  dangerButton: { backgroundColor: "#FFE5E5", marginTop: 20 },
  dangerButtonText: { fontSize: 15, fontWeight: "500", color: "#FF3B30" },
  infoBox: { backgroundColor: "#f5f5f5", padding: 16, borderRadius: 10, marginVertical: 12 },
